...
class FcmPlanStatusChanged extends \yii\base\Model
{
    ...
    public function __construct($plan_pool){ 
        Yii::$app->language = SysRegion::mapCountryToNativeLanguage($plan_pool->region_id);
    ...
    private function getCopy($plan_pool) {
        ...
        switch ($plan_pool->plan_status) {
            ...
            case InstapPlanPool::STATUS_ACTIVE:
                $copy = [Yii::t("common","Plan activated"), $plan_pool->policy_number, Yii::t("common",'Plan is activated. Have your peace of mind.')];
                break;
