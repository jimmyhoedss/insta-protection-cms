...
<div class="dealer-form">
    ...
    <?php 
        ...
        $widget_config = [
            'data' => $c,
            'options' => ['placeholder' => 'Select Upline Company ...'],
            'pluginOptions' => ['allowClear' => true, 'disabled' => !$model->isNewRecord],
        ];
        ...
        $html .= $form->field($modelCompanyRelation, 'dealer_company_upline_id')->widget(Select2::classname(), $widget_config)->label('Upline Company')->hint("<i>This field is optional</i>");
        $html .= "</div>";
