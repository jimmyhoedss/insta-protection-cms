...
use backend\assets\TestChart;
use kongoon\orgchart\OrgChart;
use common\components\Utility;


TestChart::register($this);
?>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <p><?=Yii::t('backend', "Unique Visitors")?></p>
            </div>
            <div class="icon">
              <i class="ion ion-pie-graph"></i>
            </div>
            <a href="#" class="small-box-footer"><?=Yii::t('backend', 'More info')?> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
...
<?php
    ...
    $data = $data;
    $str =  Utility::enclose_quotes_str($data);
$script = <<< JS
