...
/* @var $form ActiveForm */
$this->title = 'Send Push Notification Message To: <b>' . utf8_decode($userProfile->nickname) . "</b> (" . $userProfile->user->email . ")";
...
<div class="firebase-cloud-messaging">
    <?php
        ...
        echo $this->render($form, [
            'model' => $model,
            'recipient_type' => PushNotification::RECIPIENT_TYPE_DEVICE,
            'recipient'=> $user_id,
