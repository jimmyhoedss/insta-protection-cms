    ...
    public function actionUpdate($id) {
        ...
        if ($modelAction->load(Yii::$app->request->post()) && $modelCase->load(Yii::$app->request->post())  && $claimActionForm->load(Yii::$app->request->post())) {
            ...
            try{
                ...
                if ($modelAction->save() && $model->save() && $pool->save()) {
                    ...
                    if($claimActionForm->validate() && !$modelAction->hasErrors() && !$model->hasErrors() && !$pool->hasErrors()) {
                        $success = true;
                    }
            ...
            if ($success) {
                ...
                if ($modelAction->hasErrors()){
                    //oh: set current_case_status to empty to prevent disappear of dropdown select form when error occur
