...
class CustomRateLimiter extends RateLimiter
{
    ...
    public function checkRateLimit($user, $request, $response, $action)
    {
        ...
        if ($allowance < 1) {
            ...
            throw new CustomHttpException(Utility::jsonifyError("rate_limiter", $this->errorMessage, CustomHttpException::KEY_TOO_MANY_REQUEST), CustomHttpException::TOO_MANY_REQUEST);
        }
